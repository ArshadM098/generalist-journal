...
export function HamBtn({handler}){
    ...
    return (
        <div className="h-fit w-fit p-1 bg-transparent backdrop-blur-lg rounded-md"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" onClick={() => {handler}}>
